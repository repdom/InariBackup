...
--
-- Table structure for table `formularioarea`
--

DROP TABLE IF EXISTS `formularioarea`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `formularioarea` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `area` int(11) DEFAULT NULL,
  `formularioModelo` int(11) DEFAULT NULL,
  `cancelado` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2019-02-28 23:48:46
