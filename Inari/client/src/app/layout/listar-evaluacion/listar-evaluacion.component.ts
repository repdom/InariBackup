...
export class ListarEvaluacionComponent implements OnInit {
  ...
  listarEvaluaciones() {
    this.spinner.show();
    this.evaluacionService.getFilterByModelAndOrderByDate().subscribe(responseEvaluacion => {
      this.spinner.show();
                  ...
                  <div class="row">
                    <div class="col-xs-6">
                      ...
                      <strong>Evaluador:</strong><br>
                        ${evaluacion.evaluador.primerNombre} ${(evaluacion.evaluador.segundoNombre!== null && evaluacion.evaluador.segundoNombre !== '') ? evaluacion.evaluador.segundoNombre : ''}<br>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-6 text-right">
                      <address>
                        ...
                        ${evaluacion.fechaCompletaCreacion}<br>
                      </address>
                    </div>
                  </div>
                </div>
...
imprimir += `<div class="row">
          ...
          imprimir += `<thead>
                          <tr id="top">
                              <td><strong>Item</strong></th>
                              <td class="text-center"><strong>Definición</strong></th>
                              <td class="text-center"><strong>Cumple</strong></th>
                              <td class="text-right"><strong>Comentario</strong></th>
                          </tr>
                      </thead>
                      <tbody>`;
            evaluacion.itemsEvaluados.forEach(item => {
              imprimir += `<tr>
                              ...
                              <td class="text-center">${item.definicion}</td>
                              <td class="text-center">${(item.evaluacion === 0) ? 'Si' : 'No'}</td>
                              <td class="text-right">
