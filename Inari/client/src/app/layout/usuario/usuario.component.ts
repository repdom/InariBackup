...
export class UsuarioComponent implements OnInit {
  ...
  crearUsuario() {
    ...
    && this.nuevoUsuario.segundoNombre !== '' && this.nuevoUsuario.primerApellido !== ''
    && this.nuevoUsuario.segundoApellido !== '' && this.nuevoUsuario.username !== '') {
      const nuevoUsuario = {
      ...
      const indice = this.colaboradores.push({
        ...
        id: 0,
        password: this.nuevoUsuario.password,
        Rol: this.roles.filter(rol => rol.id === this.nuevoUsuario.Rol.id)[0],
