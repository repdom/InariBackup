...
module.exports = function (FormularioEvaluacion) {
    ...
    FormularioEvaluacion.insertarConItemes = function(formularioEvaluacion,cb) {
        FormularioEvaluacion.create(formularioEvaluacion, function (err, result) {
            if (err) {
                ...
                items = items.map(item => {return {...formularioEvaluacion.items, formularioEvaluacionCodigo: formularioCodigo}});
    ...
    FormularioEvaluacion.remoteMethod(
        'insertarConItemes', {
            ...
            accepts:{ arg: 'formularioEvaluacion', type: 'FormularioEvaluacion', required: true, http: { source: 'body' }},
