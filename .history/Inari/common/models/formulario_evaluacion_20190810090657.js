...
module.exports = function (FormularioEvaluacion) {
    ...
    FormularioEvaluacion.insertarConItemes = function(formularioEvaluacion,cb) {
        formularioEvaluacion.formularios.forEach(function(element) {
            FormularioEvaluacion.upsert(element.formulario, function (     app.models.Email.send({
                to: 'juan.thomas.angel@gmail.com',
              ...
              app.models.Email.send({
                ...
                if (err) {
                    ...
                    if (result.bloqueado === true) {
                        FormularioEvaluacion.app.models.ColaMensajeria.find({}, function(colaMensajeria) {
                            cosole.log(colaMensajeria);
                        });
                    }
