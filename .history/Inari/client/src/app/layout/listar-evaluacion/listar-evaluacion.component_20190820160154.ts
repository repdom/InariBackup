...
export class ListarEvaluacionComponent implements OnInit, AfterViewInit {
  ...
  buscarFiltro() {
    ...
    if (this.fechaFiltroInicio && this.fechaFiltroFin) {
      ...
      this.buscarEvaluacionesConFiltro(0, this.tamPagina, null, JSON.stringify(this.opcionFiltroSemaforo));
    } else if (this.fechaFiltroInicio && this.fechaFiltroFin && this.filtrosWhere) {
      console.log(JSON.stringify(this.filtrosWhere));
      this.buscarEvaluacionesConFiltro(0, this.tamPagina, JSON.stringify(this.filtrosBetween), JSON.stringify(this.opcionFiltroSemaforo));
    }
  }
