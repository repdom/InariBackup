  ...
  buscarFiltro(pageEvent: PageEvent) {
    ...
    if (this.filtrando === false) {
      ...
      if (this.fechaFiltroInicio && this.fechaFiltroFin && this.opcionFiltroSemaforo.bloqueado === 0 && this.opcionFiltroSemaforo.hallazgos === 0 && this.opcionFiltroSemaforo.liberado === 0) {
        this.filtrando = true;
        console.log(JSON.stringify(this.filtrosBetween));
        this.buscarEvaluacionesConFiltro(this.tamPagina, 0, null, JSON.stringify(this.filtrosBetween));
      } else if (!this.fechaFiltroInicio && !this.fechaFiltroFin) {
        // tslint:disable-next-line:max-line-length
        this.filtrando = true;
        this.buscarEvaluacionesConFiltro(this.tamPagina, 0, JSON.stringify(this.opcionFiltroSemaforo), null);
      } else if (this.fechaFiltroInicio && this.fechaFiltroFin && this.opcionFiltroSemaforo) {
        console.log(JSON.stringify(this.opcionFiltroSemaforo));
        this.filtrando = true;
        // tslint:disable-next-line:max-line-length
        this.buscarEvaluacionesConFiltro(this.tamPagina, 0, JSON.stringify(this.opcionFiltroSemaforo), JSON.stringify(this.filtrosBetween));
      }
    } else {
      this.indicePagina = pageEvent.pageIndex + 1;
      this.tamAnterior = this.tamPagina;
      ...
      if (this.fechaFiltroInicio && this.fechaFiltroFin && this.opcionFiltroSemaforo.bloqueado === 0 && this.opcionFiltroSemaforo.hallazgos === 0 && this.opcionFiltroSemaforo.liberado === 0) {
        this.filtrando = true;
        console.log(JSON.stringify(this.filtrosBetween));
        this.buscarEvaluacionesConFiltro(this.tamPagina, this.tamPagina * pageEvent.pageIndex, null, JSON.stringify(this.filtrosBetween));
      } else if (!this.fechaFiltroInicio && !this.fechaFiltroFin) {
        // tslint:disable-next-line:max-line-length
        this.filtrando = true;
        this.buscarEvaluacionesConFiltro(this.tamPagina, this.tamPagina * pageEvent.pageIndex, JSON.stringify(this.opcionFiltroSemaforo), null);
      } else if (this.fechaFiltroInicio && this.fechaFiltroFin && this.opcionFiltroSemaforo) {
        console.log(JSON.stringify(this.opcionFiltroSemaforo));
        this.filtrando = true;
        // tslint:disable-next-line:max-line-length
        this.buscarEvaluacionesConFiltro(this.tamPagina, this.tamPagina * pageEvent.pageIndex, JSON.stringify(this.opcionFiltroSemaforo), JSON.stringify(this.filtrosBetween));
      }
    }
  }

  agregarValorFiltroWhereArea() {
    // this.opcionFiltroSemaforo.codigoArea = this.codigoArea;
  }
