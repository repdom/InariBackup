...
export class ListarEvaluacionComponent implements OnInit, AfterViewInit {
  ...
  limpiarBusqueda() {
    this.fechaFiltroInicio this.fechaFiltroFin && this.opcionFiltroSemaforo.bloqueado === 0 && this.opcionFiltroSemaforo.hallazgos === 0 && this.opcionFiltroSemaforo.liberado === 0
  }
