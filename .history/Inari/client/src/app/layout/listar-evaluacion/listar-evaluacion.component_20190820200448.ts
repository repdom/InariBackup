...
export class ListarEvaluacionComponent implements OnInit, AfterViewInit {
  ...
  buscarFiltro(pageEvent: PageEvent) {
    ...
    if (this.filtrando === false) {
      ...
      // tslint:disable-next-line:max-line-length
      } else if (this.fechaFiltroInicio && this.fechaFiltroFin && this.opcionFiltroSemaforo.areaCodigo === 0 && (this.opcionFiltroSemaforo.hallazgos > 0 || this.opcionFiltroSemaforo.liberado > 0 || this.opcionFiltroSemaforo.bloquead o)) {
