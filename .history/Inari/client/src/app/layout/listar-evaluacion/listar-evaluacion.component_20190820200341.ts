...
export class ListarEvaluacionComponent implements OnInit, AfterViewInit {
  ...
  buscarFiltro(pageEvent: PageEvent) {
    ...
    if (this.filtrando === false) {
      ...
      } else if (this.fechaFiltroInicio && this.fechaFiltroFin && this.opcionFiltroSemaforo.areaCodigo === 0 && (this.opcionFiltroSemaforo.hallazgos > 0 || this.opcionFiltroSemaforo.hallazgos)) {
