...
export class ListarEvaluacionComponent implements OnInit, AfterViewInit {
  ...
  buscarFiltro() {
    ...
    if (this.fechaFiltroInicio && this.fechaFiltroFin, this.opcionFiltroSemaforo) {
      console.log(JSON.stringify(this.filtrosBetween));
      this.buscarEvaluacionesConFiltro(0, this.tamPagina, JSON.stringify(this.filtrosBetween), JSON.stringifythis.opcionFiltroSemaforo);
