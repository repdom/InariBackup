...
export class ListarEvaluacionComponent implements OnInit, AfterViewInit {
  ...
  buscarFiltro(pageEvent: PageEvent) {
    ...
    if (this.filtrando === false) {
      ...
      } else if (!this.fechaFiltroInicio && !this.fechaFiltroFin && this.opcionFiltroSemaforo.areaCodigo === 0) {
        // tslint:disable-next-line:max-line-length
        this.cargarCantidadFiltrada(JSON.stringify(this.opcionFiltroSemaforo), null);
      // tslint:disable-next-line:max-line-length
      } else if (this.fechaFiltroInicio && this.fechaFiltroFin && this.opcionFiltroSemaforo.areaCodigo === 0 && (this.opcionFiltroSemaforo.hallazgos > 0 || this.opcionFiltroSemaforo.liberado > 0 || this.opcionFiltroSemaforo.bloqueado > 0)) {
        console.log(JSON.stringify(this.opcionFiltroSemaforo));
        // tslint:disable-next-line:max-line-length
        this.cargarCantidadFiltrada(JSON.stringify(this.opcionFiltroSemaforo), JSON.stringify(this.filtrosBetween));
      // tslint:disable-next-line:max-line-length
      } else if (this.opcionFiltroSemaforo.areaCodigo > 0 && this.fechaFiltroInicio && this.fechaFiltroFin && this.opcionFiltroSemaforo.bloqueado === 0 && this.opcionFiltroSemaforo.hallazgos === 0 && this.opcionFiltroSemaforo.liberado === 0) {
        const filtroArea = {
          areaCodigo: this.opcionFiltroSemaforo.areaCodigo
        };
        this.cargarCantidadFiltrada(JSON.stringify(filtroArea), JSON.stringify(this.filtrosBetween));
      // tslint:disable-next-line:max-line-length
      } else if (this.opcionFiltroSemaforo.areaCodigo > 0 && !this.fechaFiltroInicio && !this.fechaFiltroFin && this.opcionFiltroSemaforo.bloqueado === 0 && this.opcionFiltroSemaforo.hallazgos === 0 && this.opcionFiltroSemaforo.liberado === 0) {
        const filtroArea = {
          areaCodigo: this.opcionFiltroSemaforo.areaCodigo
        };
        this.cargarCantidadFiltrada(JSON.stringify(filtroArea), null);
      }
    }
    if (this.filtrando === false) {
      // this.indicePagina = pageEvent.pageIndex + 1;
      ...
      } else if (!this.fechaFiltroInicio && !this.fechaFiltroFin && !this.fechaFiltroFin && this.opcionFiltroSemaforo.areaCodigo === 0) {
        // tslint:disable-next-line:max-line-length
        this.filtrando = true;
      ...
      } else if (this.opcionFiltroSemaforo.areaCodigo > 0 && this.fechaFiltroInicio && this.fechaFiltroFin) {
        const filtroArea = {
          areaCodigo: this.opcionFiltroSemaforo.areaCodigo
        };
        this.buscarEvaluacionesConFiltro(0, this.tamPagina, JSON.stringify(filtroArea), JSON.stringify(this.filtrosBetween));
      } else if (this.opcionFiltroSemaforo.areaCodigo > 0) {
        const filtroArea = {
          areaCodigo: this.opcionFiltroSemaforo.areaCodigo
        };
        this.buscarEvaluacionesConFiltro(0, this.tamPagina, JSON.stringify(filtroArea), null);
      }
    } else {
      this.indicePagina = pageEvent.pageIndex + 1;
      this.tamAnterior = this.tamPagina;
      ...
      if (this.fechaFiltroInicio && this.fechaFiltroFin && this.opcionFiltroSemaforo.bloqueado === 0 && this.opcionFiltroSemaforo.hallazgos === 0 && this.opcionFiltroSemaforo.liberado === 0) {
        ...
        this.filtrando = true;
        // tslint:disable-next-line:max-line-length
        this.buscarEvaluacionesConFiltro(this.tamPagina * pageEvent.pageIndex, this.tamPagina, JSON.stringify(this.opcionFiltroSemaforo), null);
      } else if (this.fechaFiltroInicio && this.fechaFiltroFin && this.opcionFiltroSemaforo) {
        console.log(JSON.stringify(this.opcionFiltroSemaforo));
        this.filtrando = true;
        // tslint:disable-next-line:max-line-length
        this.buscarEvaluacionesConFiltro(this.tamPagina * pageEvent.pageIndex, this.tamPagina, JSON.stringify(this.opcionFiltroSemaforo), JSON.stringify(this.filtrosBetween));
      // tslint:disable-next-line:max-line-length
      } else if (this.opcionFiltroSemaforo.areaCodigo > 0 && this.fechaFiltroInicio && this.fechaFiltroFin && this.opcionFiltroSemaforo.bloqueado === 0 && this.opcionFiltroSemaforo.hallazgos === 0 && this.opcionFiltroSemaforo.liberado === 0) {
        const filtroArea = {
          areaCodigo: this.opcionFiltroSemaforo.areaCodigo
        ...
        // tslint:disable-next-line:max-line-length
        this.buscarEvaluacionesConFiltro(this.tamPagina * pageEvent.pageIndex, this.tamPagina, JSON.stringify(filtroArea), JSON.stringify(this.filtrosBetween));
      // tslint:disable-next-line:max-line-length
      } else if (this.opcionFiltroSemaforo.areaCodigo > 0 && !this.fechaFiltroInicio && !this.fechaFiltroFin && this.opcionFiltroSemaforo.bloqueado === 0 && this.opcionFiltroSemaforo.hallazgos === 0 && this.opcionFiltroSemaforo.liberado === 0) {
        const filtroArea = {
          areaCodigo: this.opcionFiltroSemaforo.areaCodigo
        };
        this.buscarEvaluacionesConFiltro(this.tamPagina * pageEvent.pageIndex, this.tamPagina, JSON.stringify(filtroArea), null);
      }
    }
  }
