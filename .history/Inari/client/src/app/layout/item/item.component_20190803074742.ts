...
import { Item } from 'src/app/clases/formulario/formulario';
...
export class ItemComponent implements OnInit {
  public items: Item[] = [];
  public nuevoItem: Item = new Item();
  ...
  actualizarItem() {
    const itemActualizado = {
      ...
      definicion: this.nuevoItem.definicion,
      alias: this.nuevoItem.alias,
      codigoGrupo: this.nuevoItem.codigoGrupo
    };
