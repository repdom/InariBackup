...
export class DashboardComponent implements OnInit {
    ...
    ngOnInit() {
        this.calendarioService.getProgramacionActiva().subscribe(programacionResponse => {
            ...
            console.log(programacionResponse);
        }, (error) => {
    ...
    obtenerMetrica() {
        ...
        const METABASE_SITE_URL = 'http://metabase.inari.tk';
        const METABASE_SECRET_KEY = 'efa7f34e1d71c0a5d8b5207adc84295d10d906791fb89be359b03e8520668892';
        ...
        this.iFrame3 = METABASE_SITE_URL + '/embed/question/' + token + '#bordered=true&titled=true';
    }
}
