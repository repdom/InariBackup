...
export class CalendarioComponent implements OnInit {
  ...
  areasSeleccionadas = new FormControl();
  ...
  constructor(private colaboradoresService: ColaboradorService, private areaService: AreaService,
              ...
              private formularioAreaServicio: AreaFormularioService, private cookieService: CookieService) { }
  ...
  agregarCalendario() {
    ...
    this.areasSeleccionadas.value.forEach(areaSeleccionada => {
      ...
      const indice = this.calendarios.push({
        ...
        cancelado: 0,
        usuarioRelacionado: this.nuevoCalendario.usuarioRelacionado,
        usuario: this.listaColaboradores.find(c => c.id === this.nuevoCalendario.usuarioRelacionado),
        area: this.areas.find(a => a.codigo === areaSeleccionada),
      });
        ...
        this.formularioAreaServicio.getAllWhereCodigoFormularioModelo(f.areaCodigo, 'area').subscribe(r => {
          // console.log(r);
            ...
            this.formularioEvaluacion.create(f).subscribe(formulario => {
              ...
              if (this.areasSeleccionadas.value.lenght - 1 === i) {
  ...
  cancelar() {
    ...
    this.areasSeleccionadas = new FormControl();
