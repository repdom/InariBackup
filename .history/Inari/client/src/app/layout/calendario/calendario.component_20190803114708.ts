...
export class CalendarioComponent implements OnInit {
  ...
  constructor(private colaboradoresService: ColaboradorService, private areaService: AreaService,
              ...
              private formularioEvaluacion: EvaluacionService) { }
  ...
  agregarCalendario() {
    ...
    this.calendarioService.create(calendario).subscribe(calendarioResponse => {
      ...
      const f = {
      "codigo": 0,
      "fechaCreacion": "2019-08-03T12:43:58.735Z",
      "fechaGuardado": "2019-08-03T12:43:58.735Z",
      "usuarioRelacionado": 0,
      ...
      "foto9": "string",
      "foto10": "string",
      "fechaIncial": "2019-08-03T12:43:58.736Z",
      "fechaFinal": "2019-08-03T12:43:58.736Z",
      "completado": "false",
      "bloqueado": "false"
