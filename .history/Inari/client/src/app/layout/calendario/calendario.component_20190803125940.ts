...
export class CalendarioComponent implements OnInit {
  ...
  agregarCalendario() {
    ...
    this.calendarioService.create(calendario).subscribe(calendarioResponse => {
      ...
      // Eliminar foto de la esquina. Día y hora de comentario. Filtro de rojos, del más nuevo al más nuevo. 
      this.formularioAreaServicio.getAllWhereCodigoFormularioModelo('area', f.areaCodigo).subscribe(r => {
